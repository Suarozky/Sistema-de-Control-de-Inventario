...
## desiciones de diseño decidi hacerlo basico como cualquier app de administracion con un side bar y datos a la derecha datos en cards horixontales y filtros arriba creo que es una buena convencion 
de estilo
